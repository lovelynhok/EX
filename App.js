...
const LoginScreen = () => {
  ...
  const handleLogin = () => {
    Alert.alert(' Đăng nhập thành công với ' + email , ' password ' + password ) 
  };

  return (
    <View style={styles.container}>
      <ImageBackground source={{ uri: 'C:\workspace\AwesomeProject\assets\images.jpeg' }} style={styles.backgroundImage}>
